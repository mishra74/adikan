                ...
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">Categories</h4>
                          <a href="{{ route('blogs.form') }}" type="button" class="btn btn-rounded btn-primary"><span
                                 ...
                                 <tbody>
                                    ...
                                    @foreach ($blogs as $category)
                                        <tr>
                                            ...
                                            <td> <?php
                                                $words = str_word_count($category->body, 1); // Split the string into words
                                                $first_10_words = implode(' ', array_slice($words, 0, 10)); // Take the first 10 words and join them back into a string
