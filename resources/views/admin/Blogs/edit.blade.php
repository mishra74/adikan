...
@section('content')
    <div class="container-fluid">
        <div class="d-flex align-items-center mb-4">
            <h3 class="mb-0 me-auto">Edit Blogs</h3>
        </div>
        <div class="row">
            <div class="col-xl-12">
                            ...
                            <div class="row">
                                ...
                                <div class="col-xl-6  col-md-6 mb-4">
                                    ...
                                    <input type="text" class="form-control solid" name="title"
                                        id="title" placeholder="Blog title" value="{{ $blogs->title }}"
                                        aria-label="title">
...
<div class="col-xl-6  col-md-6 mb-4">
                                ...
                                <textarea id="summernote" name="body">{!! $blogs->body !!}</textarea> 
...
@push('scripts')
 ...
 {{-- Shipping Create and update Ajax Start --}}
    ...
    $('#categoryForm').submit(function(event) {
        ...
        $.ajax({
            url: '{{ route('blogs.edit.save',$blogs->id) }}',
            type: 'post',
            data: formData,
