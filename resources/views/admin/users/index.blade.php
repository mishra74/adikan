            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        ...
                        <a href="{{ route('admin.user.create') }}" class="btn btn-primary me-3 btn-sm"><i
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="action-buttons d-flex justify-content-end">
                                                    ...
                                                    <a href="{{route('admin.user.destroy',$user->id)}}" class="delete-item" data-id="{{ $user->id }}" class="btn btn-danger light">
