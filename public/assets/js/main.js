...
$('ul li:has(ul)');
    ...
    var e = '<div class="prt_floting_customsett">'+
                '<a href="contact.php" target="_blank" class="tmtheme_fbar_icons"><i class="fa fa-headphones"></i><span>Support</span></a>'+
                '<a href="https://wa.me/918296268650" target="_blank" class="tmtheme_fbar_icons"><i class="themifyicon themifyicon icon-whatsapp"></i><span>Whatsapp</span></a>'+
                '<a href="enquiry.php" target="_blank" class="tmtheme_fbar_icons"><i class="themifyicon icon-mail"></i><span class="buy_link">Enquiry<span></span></span></a>'+
